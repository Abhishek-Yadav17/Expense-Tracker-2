...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAF7F4] px-4">
      ...
      >
        <div>
          <h2 className="text-2xl font-semibold text-[#2E1E16]">Register</h2>
        ...
        <div>
          ...
          <p className="text-red-500 text-xs mt-1">{errors.password1?.message}</p>
        </div>
        ...
        <p className="text-sm text-center text-gray-600">
          ...
          <Link to="/login" className="text-[#C47A52] font-medium">
            Login
          </Link>
        </p>
      </form>
